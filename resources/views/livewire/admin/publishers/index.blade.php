<div>
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Publishers</h1>
        ...
        <div class="mt-5 flex gap-2">
            ...
            @if ($isEditing)
                ...
                <button
                    ...
                    class="rounded bg-gray-500 px-5 py-2 text-white"
                >
                    Cancel
                </button>
                        ...
                        <tr class="border-t">
                            ...
                            <td class="p-3">
                                ...
                                <div class="flex gap-2">
                                    ...
                                    <button
                                        type="button"
                                        wire:click="toggleStatus({{ $publisher->id }})"
                                        class="rounded bg-indigo-600 px-3 py-1 text-white"
                                    >
                                        {{ $publisher->is_active ? 'Deactivate' : 'Activate' }}
                                    </button>
